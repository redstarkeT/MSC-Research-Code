...
dataframe2017 = pd.read_excel(r"C:\Users\steph\OneDrive\Desktop\MSC Stuff\v2 MISLE Incident Data (Cluster0).xlsx",sheet_name = "2017" )
dataframe2018 = pd.read_excel(r"C:\Users\steph\OneDrive\Desktop\MSC Stuff\v2 MISLE Incident Data (Cluster0).xlsx",sheet_name = "2018" )
dataframe2019 = pd.read_excel(r"C:\Users\steph\OneDrive\Desktop\MSC Stuff\v2 MISLE Incident Data (Cluster0).xlsx",sheet_name = "2019" )
...
fig.update_layout(
    ...
    title = '[Cluster 0] USCG Incidents per Calendar Month 2017 to 2019',
